...
// Creator onboarding — the staged-interview vocabulary plus the two seams the flow sits
// behind: `ai` supplies the behaviour, `db` supplies the session store, `ui` renders a stage
// without knowing which one it is, and `web` carries commands to both (ADR-0022).
export {
  ...
  CREATOR_ONBOARDING_BEHAVIOR_VERSIONS,
  CreatorOnboardingBehaviorVersionSchema,
  type CreatorOnboardingBehaviorVersion,
  CreatorOnboardingAnswerSchema,
  type CreatorOnboardingAnswer,
  CreatorOnboardingSlotSchema,
  type CreatorOnboardingSlot,
  CreatorOnboardingSlotsSchema,
  ...
  type CompletedCreatorOnboardingSession,
  CreatorOnboardingSessionSchema,
  type CreatorOnboardingSession,
  CREATOR_ONBOARDING_ACTIONS,
  CreatorOnboardingActionSchema,
  type CreatorOnboardingAction,
  CreatorOnboardingActionAvailabilitySchema,
  type CreatorOnboardingActionAvailability,
  CreatorOnboardingActionModelSchema,
  type CreatorOnboardingActionModel,
  CreatorOnboardingChoiceSchema,
  type CreatorOnboardingChoice,
  CreatorOnboardingStageInputSchema,
  type CreatorOnboardingStageInput,
  ...
  CreatorOnboardingCompletionSchema,
