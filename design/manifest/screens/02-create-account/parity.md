...
| Button label  | "Create account"                   | "Continue" (`resonance-dba0`; E2E + capture updated) | ✅ visual       |

## Accepted / deferred deltas

1. **Wave mark shape (→ `resonance-cbbb`).** Token/SVG approximation of the real `Logo/Resonance`
   asset; the loop shape differs slightly.
2. **Legal terms are underlined spans, not links.** Real hrefs (Term of Use / Privacy / Notice
